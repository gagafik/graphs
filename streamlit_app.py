    ...
    if len(filtered_df) > 0:
        ...
        with col2:
            ...
            if parallel_mode and selected_parallels and len(selected_parallels) > 1:
                ...
                labels = ['Неуд (<60)', 'Удовл (60-70)', 'Хорошо (70-80)', 'Отлично (80-90)', 'Превосходно (90+)']
                ...
                if PLOTLY_AVAILABLE and len(category_counts) > 0:
                    fig_pie = go.Figure(data=[go.Pie(
                        ...
                        hole=0.3,
                        marker_colors=['#ff4444', '#ff8800', '#ffdd00', '#88dd00', '#44dd44']
                    )])
        ...
        with st.expander("📋 Детальные данные и экспорт"):
            ...
            with col2:
                summary_stats = filtered_df.groupby(['Class', 'Subject'])['Average'].agg(['mean', 'count', 'std']).round(2)
                st.download_button(
